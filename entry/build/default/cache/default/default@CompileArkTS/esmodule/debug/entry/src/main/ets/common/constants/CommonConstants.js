...
CommonConstants.FONT_WEIGHT_600 = 600;
...
// space
CommonConstants.SPACE_2 = 2;
CommonConstants.SPACE_4 = 4;
CommonConstants.SPACE_6 = 6;
CommonConstants.SPACE_8 = 8;
CommonConstants.SPACE_10 = 10;
CommonConstants.SPACE_12 = 12;
// global data key
 ...
 */
CommonConstants.RECOMMEND_CALORIE = 1962;
/**
 * 当前用户推荐的每日摄入碳水上限，单位：克
 */
CommonConstants.RECOMMEND_CARBON = 237;
/**
 * 当前用户推荐的每日摄入蛋白质上限，单位：克
 */
CommonConstants.RECOMMEND_PROTEIN = 68;
/**
 * 当前用户推荐的每日摄入脂肪上限，单位：克
 */
CommonConstants.RECOMMEND_FAT = 53;
