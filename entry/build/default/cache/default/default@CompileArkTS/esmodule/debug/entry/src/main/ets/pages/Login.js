...
class Login extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.create();
            Row.height('100%');
            Row.backgroundColor({ "id": 16777231, "type": 10001, params: [], "bundleName": "com.yuzhaopan.news", "moduleName": "entry" });
            if (!isInitialRender) {
                Row.pop();
            }
    ...
    loginBuilder(parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Stack.height(50);
            Stack.borderWidth(1);
            Stack.borderColor({ "id": 16777224, "type": 10001, params: [], "bundleName": "com.yuzhaopan.news", "moduleName": "entry" });
